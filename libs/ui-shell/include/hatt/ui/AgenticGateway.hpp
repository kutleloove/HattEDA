...
// `hatt-ui-shell`'s `AgenticActionGateway` implementation (ADR-0009): looks `hatteda.action.*`
...
public:
    ...
    // Action ids never triggered through the agentic surface, even when enabled (ADR-0009
